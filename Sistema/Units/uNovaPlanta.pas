...
begin
  if (vNumeroCad = 0) then
    ...
    Dados.SqlAtualiza('PLANTAS',
                      ...
                      'AND ID = '       + IntToStr(vNumeroCad));
  lbledtNovaPlanta.Clear;
  CarregarPlantas;
end;

procedure TfrmNovaPlanta.btnEditarClick(Sender: TObject);
begin
  Editar;
end;

procedure TfrmNovaPlanta.btnNovoClick(Sender: TObject);
begin
  lbledtNovaPlanta.Clear;
  vNumeroCad  :=  0;
end;
...
procedure TfrmNovaPlanta.Editar;
begin
